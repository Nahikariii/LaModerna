...
},{"hbsfy/runtime":39}],2:[function(require,module,exports){
...
},{"./helpers.js":1,"./routes/index":3,"backbone":30,"jquery-browserify":40}],3:[function(require,module,exports){
var Backbone = require("backbone");
...
},{"../views/business_view":4,"../views/category_view":5,"../views/contact_view":6,"../views/findus_view":8,"../views/history_view":12,"../views/index_view":13,"../views/pizza_view":15,"backbone":30}],4:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var ContentHeaderView = require("./content_header");
var FooterView = require("./footer_view");

var pagePhoto = "/images/business_header.jpg";
...
},{"../../views/business.hbs":17,"./content_header":7,"./footer_view":9,"./header_view":10,"backbone":30}],5:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var ContentHeaderView = require("./content_header");
var FooterView = require("./footer_view");
...
var data = {   'pan-especiales': {   'headerText': 'Especiales',
    ...
    'pan-integral': {   'headerText': 'Pan integral',
                        ...
                        'products': [   {   'magnified-photo': '/images/panes/154.png',
                                            ...
                                            'productTitle': '1/2 Baston Multicereal',
                                            'quantity': '40',
                                            'reference': '0148',
                                            'weight': '120 g.'},
                                        {   'magnified-photo': '/images/panes/160.png',
                                            'photo': '/images/panes/160-small.png',
    ...
    'restauracion-pintxo': {   'headerText': 'Pintxo',
                               ...
                               'products': [   {   'magnified-photo': '/images/panes/152.png',
                                                   ...
                                                   'reference': '0051',
                                                   'weight': '25 g.'},
                                               {   'magnified-photo': '/images/panes/240.png',
                                                   'photo': '/images/panes/240-small.png',
                                                   'productTitle': 'Ritxi Pequeño (Pulga)',
                                                   'quantity': '150',
                                                   'reference': '0051',
                                                   'weight': '25 g.'},
...
},{"../../views/category.hbs":18,"./content_header":7,"./footer_view":9,"./header_view":10,"backbone":30}],6:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var ContentHeaderView = require("./content_header");
var FooterView = require("./footer_view");
...
},{"../../views/contact.hbs":19,"./content_header":7,"./footer_view":9,"./header_view":10,"backbone":30}],7:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/contentheader.hbs":20,"backbone":30}],8:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var ContentHeaderView = require("./content_header");
var FooterView = require("./footer_view");
...
},{"../../views/findus.hbs":21,"./content_header":7,"./footer_view":9,"./header_view":10,"backbone":30}],9:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/footer.hbs":22,"backbone":30}],10:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/header.hbs":23,"./menu_view":14,"backbone":30}],11:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/highlights.hbs":24,"backbone":30}],12:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var FooterView = require("./footer_view");
...
},{"../../views/index.hbs":26,"./footer_view":9,"./header_view":10,"./highlights_view":11,"./slider_view":16,"backbone":30}],14:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/menu.hbs":27,"backbone":30}],15:[function(require,module,exports){
var backbone = require("backbone");
var HeaderView = require("./header_view");
var ContentHeaderView = require("./content_header");
var FooterView = require("./footer_view");
...
},{"../../views/pizza.hbs":28,"./content_header":7,"./footer_view":9,"./header_view":10,"backbone":30}],16:[function(require,module,exports){
var backbone = require("backbone");
...
},{"../../views/slider.hbs":29,"backbone":30}],17:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"page-wrap\">\n    <div class=\"header\">\n    </div>\n\n    <div id=\"content-header\">\n    </div>\n\n    <div class=\"content\">\n        <div class=\"block\">\n            <h3 class=\"orange\">Nuestros servicios</h3>\n            <p>Como se puede ver en nuestra sección de productos disponemos de una amplia oferta para el sector de la Hostelería, desde los panes más tradicionales en cuánto a pintxos, bocadillos o panes para menus del día hasta productos innovadores como pueden ser el de pasas y nueces, la focaccia, nuestra gama de mini burger o la gama de celta pintxo. </p>\n            <p>Para asegurar la calidad del producto y la satisfacción de los consumidores de nuestros clientes nos especializamos en la venta de producto precocido congelado. De manera que se puede hornear al dia para obtener una mayor frescura. Disponemos de los medios necesarios para asegurar la cadena de frio hasta que el producto llega a nuestros clientes.</p>\n            <p>Si quieres saber más sobre nuestros productos y estas interesado no dudes en <a href=\"/contacto\">contactarnos</a> te haremos una visita y llevaremos algunas muestras para que puedas conocer el producto de primera mano.</p>\n        </div>\n\n        <div class=\"block\">\n            <h3 class=\"orange\">Como funciona</h3>\n            <p>Este es un pequeño video que explica el proceso de contratación de nuestros productos.</p> \n            <div class=\"video-container embed-responsive embed-responsive-16by9\">\n                <iframe class=\"embed-responsive-item\" src=\"https://www.youtube.com/embed/2U4OAwstIy8\"></iframe>\n            </div>\n        </div>\n\n    </div>\n</div>\n\n<footer class=\"site-footer\">\n</footer>\n";
  });
...
function program1(depth0,data) {
  ...
  buffer += "\n			<div class=\"product-element\">\n				<div class=\"product-image\">\n					<img class=\"img-circle\" data-toggle=\"magnify\" src= ";
  ...
  buffer += escapeExpression(stack1)
    + " data-magnified-src= ";
  if (helper = helpers['magnified-photo']) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0['magnified-photo']); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + ">\n				</div>\n				<h4 class=\"title\">";
  ...
  buffer += "<div class=\"page-wrap products\">\n	<div class=\"header\">\n	</div>\n\n	<div id=\"content-header\">\n	</div>\n\n	<div id=\"products\">\n		";
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + " role=\"button\">";
  if (helper = helpers['continue']) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0['continue']); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + " <span class=\"glyphicon glyphicon-play\"> </span></a>\n	</div>\n";
  return buffer;
  }

  stack1 = helpers.each.call(depth0, (depth0 && depth0.highlights), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<nav class=\"navbar navbar-default\" role=\"navigation\">\n    <div class=\"navbar-header\">\n    	<button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\".navbar-collapse\">\n     		<span class=\"icon-bar\"></span>\n      		<span class=\"icon-bar\"></span>\n      		<span class=\"icon-bar\"></span>\n    	</button>    \n		<a class=\"navbar-brand\" href=\"#\">Menú</a>\n  	</div>\n	<div class=\"navbar-collapse collapse\">\n		<ul class=\"nav navbar-nav\">\n			  <li><a href=\"#\">Inicio</a></li>\n			  <li class=\"dropdown\">\n					<a class=\"dropdown-toggle\" data-toggle=\"dropdown\">Productos <b class=\"caret\"></b></a>\n					<ul class=\"dropdown-menu\">\n					  <li role=\"presentation\" class=\"dropdown-header\">Panadería</li>\n						  <li><a href=\"/productos/pan-tradicional\">Pan tradicional</a></li>\n						  <li><a href=\"/productos/pan-integral\">Pan integral</a></li>\n						  <li><a href=\"/productos/pan-rustico\">Pan rústico</a></li>\n						  <li><a href=\"/productos/pan-especiales\">Especiales</a></li>\n					  <li role=\"presentation\" class=\"divider\"></li>\n					  <li role=\"presentation\" class=\"dropdown-header\">Restauración</li>\n						  <li><a href=\"/productos/restauracion-burger\">Burger</a></li>\n						  <li><a href=\"/productos/restauracion-bocata\">Bocata</a></li>\n						  <li><a href=\"/productos/restauracion-pintxo\">Pintxo</a></li>\n					</ul>\n			  </li>\n			  <li><a href=\"/hosteleria\">Hostelería</a></li>\n			  <li><a href=\"/tiendas\">Donde estamos</a></li>\n			  <li><a href=\"/historia\">Historia</a></li>\n			  <li><a href=\"/contacto\">Contacto</a></li>\n		</ul>\n	</div>\n</nav>\n";
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"page-wrap\">\n    <div class=\"header\">\n    </div>\n\n    <div id=\"content-header\">\n    </div>\n\n    <div class=\"content\">\n        <div class=\"block\">\n            <h3 class=\"orange\">Como conseguir nuestra masa</h3>\n            <p>Tenemos varias <a href=\"/tiendas\">tiendas</a> repartidas por Bizkaia encuentra la más cercana y pregunta por nuestra masa de pizza. En el directorio de tiendas puedes encontrar el telefono de estas, siempre puedes llamar para asegurarte de que todavía quedan masas.</p>\n        </div>\n\n        <div class=\"block\">\n            <h3 class=\"orange\">Paso a paso</h3>\n            <p>A continuación te explicamos los pasos a seguir para conseguir una pizza perfecta.</p>\n        </div>\n\n         <div class=\"block\">\n              <ol class=\"labels-list\">\n                   <li>Una vez has comprado la masa de pizza, como con cualquier producto congelado, guárdala en el congelador en cuanto llegues a casa.</li>\n                   <li>El día que quieras hacer pizza tendrás que sacar la masa del congelador alrededor de 8 horas antes de la hora en la que quieras comerla, para que fermente. Colocala en un plato grande, ya que crecerá y deja el plato en un recinto cerrado. Un buen ejemplo es el horno (importante, no dejarlo en el horno si se ha usado recientemente y esta caliente)</li>\n                   <li>Una media hora antes de la comida/cena saca el plato del horno para amasar la pizza y empezar a cocinar. Puedes empezar a calentar el horno a 200º mientras terminas de preparar la pizza.</li>\n                   <li>Hora de amasar. Coloca un papel de horno en una superficie lisa y esparce un poco de harina. (Consejo: utiliza un colador para esparcir y evitar excesos). Coloca el plato boca abajo y ayúdate con la mano para sacar la masa. Poco a poco empieza a estirar la masa para el exterior. No fuerces la masa, es importante amasarla con cuidado para que no se rompa. A continuación podrás ver un vídeo de como hacerlo. Deja de amasar cuando la pizza tenga aproximadamente una mano de radio.</li>\n                   <li>Es hora de poner tus ingredientes favoritas en la pizza. Te recomendamos utilizar un tomate casero y una buena mozarella para conseguir un mejor resultado, y no te olvides del orégano.</li>\n                   <li>Una vez el horno este listo puedes meter la pizza. Estará lista en aproximadamente 10-15 minutos. Una vez este doradita y el queso este derretido puedes sacarla.</li>\n            </ol>\n        </div>\n\n        <div class=\"block\">\n            <h3 class=\"orange\">Amasar</h3>\n\n            <p>A continuación tienes un ejemplo de como amasar una masa de pizza.</p>\n            <div class=\"video-container embed-responsive embed-responsive-16by9\">\n                <iframe class=\"embed-responsive-item\" src=\"//www.youtube.com/embed/ySOj0fFWo1U?theme=light\"></iframe>\n            </div>\n        </div>\n    </div>\n</div>\n\n<footer class=\"site-footer\">\n</footer>\n";
  });
...
function program4(depth0,data) {
  ...
  buffer += "<div id=\"carousel-main\" class=\"carousel slide text-center\" data-ride=\"carousel\"\n    <!-- Indicators -->\n    <ol class=\"carousel-indicators\">\n        <li data-target=\"#carousel-main\" data-slide-to=\"0\" class=\"active\"></li>\n        <li data-target=\"#carousel-main\" data-slide-to=\"1\"></li>\n        <li data-target=\"#carousel-main\" data-slide-to=\"2\"></li>\n    </ol>\n\n    <!-- Wrapper for slides -->\n    <div class=\"carousel-inner\">\n		";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.slider), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
